...
const config = {
    ...
    accessTokenStorageKey: "bodycal_session",
    accessTokenExpiresInStorageKey: "bodycal_session_expires_in",
    accessTokenExpiresAtStorageKey: "bodycal_session_expires_at",
    accessTokenExpiryTimeLeftForFrontendAutoRefresh: 18000, // in seconds, 18000secs = 5 hours
    referralCodeStorageKey: "bodycal_referral_code",
