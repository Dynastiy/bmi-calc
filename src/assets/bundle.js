  ...
  return (function (t) {
        ...
        return (
          ...
          e &&
            ((o.count = function (n, r) {
              return (
                i.setTime(+n), u.setTime(+r), t(i), t(u), Math.floor(e(i, u))
              );
            }),
            (o.every = function (t) {
              return (
    ...
    function (t, n, e) {
      ...
      function a(t, n, r) {
        function i(t) {
          (r.state = h),
            r.timer.restart(u, r.delay, r.time),
            r.delay <= t && u(t - r.delay);
        }
        function u(i) {
          var l, b, y, _;
          ...
          if (
            (e.i(c.d)(function () {
              r.state === p &&
                ((r.state = v), r.timer.restart(a, r.delay, r.time), a(i));
            }),
            (r.state = d),
            ...
            for (
              r.state = p, f = new Array((y = r.tween.length)), l = 0, b = -1;
              l < y;
              ++l
            )
              (_ = r.tween[l].value.call(t, t.__data__, r.index, r.group)) &&
                (f[++b] = _);
            f.length = b + 1;
          }
        }
        function a(n) {
          for (
            ...
            f[i].call(null, e);
          r.state === b &&
            (r.on.call("end", t, t.__data__, r.index, r.group), o());
        }
        function o() {
      ...
      function u(t) {
        ...
        return (
          ...
          (n.clipAngle = function (t) {
            return arguments.length
              ? ((D = +t ? e.i(o.a)((O = t * l.g)) : ((O = null), a.a)), g())
              : O * l.h;
          }),
          ...
          function () {
            return (
              (y = t.apply(this, arguments)), (n.invert = y.invert && i), d()
            );
          }
        );
      }
    ...
    function (t, n, e) {
      ...
      var a = {
          ...
          FeatureCollection: function (t, n) {
            for (var e = t.features, i = -1, u = e.length; ++i < u; )
              r(e[i].geometry, n);
          },
        },
        o = {
          ...
          MultiLineString: function (t, n) {
            for (var e = t.coordinates, r = -1, u = e.length; ++r < u; )
              i(e[r], n, 0);
          },
          ...
          GeometryCollection: function (t, n) {
            for (var e = t.geometries, i = -1, u = e.length; ++i < u; )
              r(e[i], n);
          },
        };
      n.a = function (t, n) {
            ...
            return (
              ...
              i > 0
                ...
                : i < 0 &&
                  ...
                  (i = e.i(u.A)(f, s, r))),
              i > 0
                ? ((a[o] = Math.floor(f / i) * i),
                  (a[c] = Math.ceil(s / i) * i),
                  n(a))
                : i < 0 &&
                  ((a[o] = Math.ceil(f * i) / i),
                  (a[c] = Math.floor(s * i) / i),
                  n(a)),
              t
            );
          }),
    ...
    function (t, n, e) {
      ...
      function u(t, n) {
        ...
        for (f = [], o = new Array(t.length), a = new p.a(), c = new p.a(); ; )
          if (
            ((v = h.a), b && (!v || b[1] < v.y || (b[1] === v.y && b[0] < v.x)))
          )
            (b[0] === r && b[1] === u) || (e.i(s.a)(b), (r = b[0]), (u = b[1])),
              (b = t.pop());
          else {
            if (!v) break;
            e.i(s.b)(v.arc);
      ...
      u.prototype = {
        ...
        find: function (t, n, e) {
          for (
            var r, i, u = this, a = u._found || 0, o = u.cells.length;
            !(i = u.cells[a]);
    ...
    function (t, n, e) {
      ...
      function r(t, n, r, l) {
        ...
        return function (i) {
          ...
          function m() {
            w && (x(N, A), S && C && q.rejoin(), w.push(q.result())),
              (L.point = p),
              C && R.lineEnd();
          }
          function x(i, u) {
            ...
            if ((M && k.push([i, u]), P))
              (N = i),
                ...
                (S = o),
                (P = !1),
                o && (R.lineStart(), R.point(i, u));
            else if (o && C) R.point(i, u);
            else {
              var c = [
                  (T = Math.max(s, Math.min(f, T))),
                  (E = Math.max(s, Math.min(f, E))),
                ],
                d = [
                  (i = Math.max(s, Math.min(f, i))),
                  (u = Math.max(s, Math.min(f, u))),
                ];
              e.i(a.a)(c, d, t, n, r, l)
                ? (C || (R.lineStart(), R.point(c[0], c[1])),
                  R.point(d[0], d[1]),
                  o || R.lineEnd(),
                  (z = !1))
    ...
    function (t, n, e) {
      ...
      (r.invert = r),
        (n.a = function (t) {
          function n(n) {
            return (
              (n = t(n[0] * f.g, n[1] * f.g)), (n[0] *= f.h), (n[1] *= f.h), n
            );
          }
          return (
    ...
    function (t, n, e) {
      ...
      function o(t, n, r, i) {
        var u = Math.min(t.length, n.length) - 1,
          ...
          c = -1;
        for (
          t[u] < t[0] && ((t = t.slice().reverse()), (n = n.slice().reverse()));
          ++c < u;
      ...
      function f(t, n) {
        function e() {
          return (
            (f = Math.min(b.length, g.length) > 2 ? o : a), (s = d = null), c
          );
        }
        function c(n) {
      ...
      function r(t) {
        return function () {
          var n = this.ownerDocument,
            e = this.namespaceURI;
          return e === a.b && n.documentElement.namespaceURI === a.b
            ? n.createElement(t)
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        ...
        if (((t += ""), arguments.length < 2)) {
          for (
            var o, c = e.i(a.f)(this.node(), u).tween, f = 0, s = c.length;
            f < s;
            ++f
          )
        ...
        r.forEach(function (r, c) {
          ...
          if (o) {
            ...
            d.on("mouseover", function () {
              d.style("opacity", 0.8),
                p.transition().duration(50).ease(l.easeLinear).attr("fill", r);
      ...
      (r.prototype = i.prototype =
        {
          ...
          entries: function () {
            var t = [];
            for (var n in this)
              n[0] === u && t.push({ key: n.slice(1), value: this[n] });
            return t;
          },
          size: function () {
            var t = 0;
        ...
        function e(t, n) {
          function e() {
            ...
            if (t.charCodeAt(r) === c) {
              for (
                ;
                (l++ < u && t.charCodeAt(l) !== c) || t.charCodeAt(++l) === c;
          ...
          var r,
            ...
            p = !1;
          for (
            t.charCodeAt(u - 1) === f && --u, t.charCodeAt(u - 1) === s && --u;
            (r = e()) !== o;
      ...
      function r(t, n) {
        ...
        return (
          (r.invert = function (t, n) {
            var r = f - n;
            return [
              (e.i(i.e)(t, e.i(i.p)(r)) / o) * e.i(i.q)(r),
              e.i(i.f)((c - (t * t + r * r) * o * o) / (2 * o)),
            ];
          }),
          r
        );
    ...
    function (t, n, e) {
      ...
      function r(t, n) {
        ...
        for (null == n && (n = u); (e = h.pop()); )
          if (
            (l && (e.value = +e.data.value), (i = n(e.data)) && (f = i.length))
          )
            for (e.children = new Array(f), a = f - 1; a >= 0; --a)
              h.push((r = e.children[a] = new c(i[a]))),
                (r.parent = e),
                (r.depth = e.depth + 1);
      ...
      n.c = function (t, n, e) {
          ...
          f = c.length;
        {
          if (!(arguments.length < 2)) {
            for (s = n ? o : a, null == e && (e = !1), r = 0; r < f; ++r)
              this.each(s(c[r], n, e));
            return this;
          }
    ...
    function (t, n, e) {
      ...
      function r(t, n, e) {
        ...
        if (t._l23_a > u.a) {
          ...
          (a = (a * s + t._x1 * t._l23_2a - n * t._l12_2a) / l),
            (o = (o * s + t._y1 * t._l23_2a - e * t._l12_2a) / l);
        }
    ...
    function (t, n, e) {
      ...
      n.a = function () {
        ...
        return (
          (t.x = function (r) {
            return arguments.length
              ? ((n = "function" == typeof r ? r : e.i(i.a)(+r)), t)
              : n;
          }),
          (t.y = function (n) {
            return arguments.length
              ? ((o = "function" == typeof n ? n : e.i(i.a)(+n)), t)
              : o;
          }),
          (t.defined = function (n) {
            return arguments.length
              ? ((c = "function" == typeof n ? n : e.i(i.a)(!!n)), t)
              : c;
          }),
          (t.curve = function (n) {
    ...
    function (t, n, e) {
      ...
      function l(t) {
        if (!p) {
          v && (v = clearTimeout(v));
          t - _ > 24
            ? (t < 1 / 0 && (v = setTimeout(c, t - x.now() - m)),
              b && (b = clearInterval(b)))
    ...
    function (t, n, e) {
      ...
      function c(t, n, e, r) {
        for (var i, u = f.d.length; u--; )
          (o((i = f.d[u]), t, n, e, r) &&
            a(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > f.b ||
              Math.abs(i[0][1] - i[1][1]) > f.b)) ||
            delete f.d[u];
      }
            ...
            if (
              ...
              do {
                ...
                if (t === i.L) {
                  ...
                  ((n = i.L),
                  n.C && ((n.C = !1), (i.C = !0), a(this, i), (n = i.L)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.L && n.L.C) ||
                    ((n.R.C = !1), (n.C = !0), u(this, n), (n = i.L)),
                    (n.C = i.C),
                    (i.C = n.L.C = !1),
                    a(this, i),
                    (t = this._);
    ...
    function (t, n, e) {
      ...
      (n.b = r),
        (n.a = function (t, n) {
          null == n && (n = r);
          for (
            var e = 0, i = t.length - 1, u = t[0], a = new Array(i < 0 ? 0 : i);
            e < i;
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        for (var n = -1, u = e.i(i.a)(t, r), a = new Array(u); ++n < u; )
          for (var o, c = -1, f = (a[n] = new Array(o)); ++c < o; )
            f[c] = t[c][n];
        return a;
      };
    },
      ...
      n.a = function (t) {
        ...
        return (
          ...
          (s = {
            ...
            force: function (t, n) {
              return arguments.length > 1
                ? (null == n ? b.remove(t) : b.set(t, f(n)), s)
                : b.get(t);
            },
            find: function (n, e, r) {
              var i,
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        ...
        return c === f
          ...
          : "0." +
            new Array(1 - c).join("0") +
            e.i(i.a)(t, Math.max(0, n + c - 1))[0];
      };
    },
    function (t, n, e) {
      "use strict";
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        function n(t) {
          function n(t) {
              ...
              if (
                ...
                for (n = -1, e = t.length; ++n < e; )
                  if (48 > (a = t.charCodeAt(n)) || a > 57) {
                    (f = (46 === a ? p + t.slice(n + 1) : t.slice(n)) + f),
                      (t = t.slice(0, n));
                    break;
                  }
            }
            ...
            switch (
              (y &&
                l &&
                ((t = h(N + t, N.length ? g - f.length : 1 / 0)), (N = "")),
              i)
            ) {
              case "<":
                t = o + t + f + N;
        ...
        var h =
            t.grouping && t.thousands ? e.i(i.a)(t.grouping, t.thousands) : f.a,
          d = t.currency,
          p = t.decimal,
    ...
    function (t, n, e) {
      ...
      function r(t, n, r, a, c, f) {
        if (r) {
          ...
          for (var d, p = c; a > 0 ? p > f : p < f; p -= h)
            (d = e.i(u.g)([s, -l * e.i(o.c)(p), -l * e.i(o.d)(p)])),
              t.point(d[0], d[1]);
        }
      }
      function i(t, n) {
      ...
      n.a = function () {
        ...
        return (
          (n.center = function (t) {
            return arguments.length
              ? ((f = "function" == typeof t ? t : e.i(a.a)([+t[0], +t[1]])), n)
              : f;
          }),
          (n.radius = function (t) {
            return arguments.length
              ? ((s = "function" == typeof t ? t : e.i(a.a)(+t)), n)
              : s;
          }),
          (n.precision = function (t) {
            return arguments.length
              ? ((l = "function" == typeof t ? t : e.i(a.a)(+t)), n)
              : l;
          }),
          n
        );
    ...
    function (t, n, e) {
      ...
      function i(t, n, r, i) {
        ...
        return e.i(o.p)(c) > o.o
          ? e.i(o.l)(
              (e.i(o.d)(n) * (a = e.i(o.c)(i)) * e.i(o.d)(r) -
                e.i(o.d)(i) * (u = e.i(o.c)(n)) * e.i(o.d)(t)) /
                (u * a * c)
            )
          : (n + i) / 2;
      }
        ...
        function f(t) {
          ...
          return {
            ...
            point: function (h, d) {
              ...
              !y || (n && e.i(a.a)(n, g)) || t.point(g[0], g[1]),
                (n = g),
                (i = y),
                (r = _);
            },
    ...
    function (t, n, e) {
      ...
      function i(t, n) {
        return (
          ((t = t.x)[0] < 0 ? t[1] - o.k - o.o : o.k - t[1]) -
          ((n = n.x)[0] < 0 ? n[1] - o.k - o.o : o.k - n[1])
        );
      }
      var u = e(127),
        a = e(130),
            ...
            if ((x.pop(), _.push(x), (x = null), o))
              if (1 & u) {
                if (((e = a[0]), (n = e.length - 1) > 0)) {
                  for (
                    N || (l.polygonStart(), (N = !0)), l.lineStart(), t = 0;
                    t < n;
                    ++t
                  )
                    l.point((i = e[t])[0], i[1]);
                ...
                o > 1 && 2 & u && a.push(a.pop().concat(a.shift())),
                  m.push(a.filter(r));
          }
          var _,
            m,
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n, a, o, c) {
        ...
        if (
          ...
          for (h.sort(n), i(l), i(h), f = 0, s = h.length; f < s; ++f)
            h[f].e = a = !a;
          for (var d, p, v = l[0]; ; ) {
            ...
            do {
              if (((b.v = b.o.v = !0), b.e)) {
                ...
                if (g)
                  for (d = b.p.z, f = d.length - 1; f >= 0; --f)
                    c.point((p = d[f])[0], p[1]);
    ...
    function (t, n, e) {
      ...
      function r(t, n) {
        ...
        for (e = 0; e < t.length; ++e)
          if (i(n, t[e]) && a(f(t[e], n), t)) return [t[e], n];
      ...
      n.a = function (t) {
        for (
          var n, i, a = 0, c = (t = e.i(l.a)(l.b.call(t))).length, f = [];
          a < c;
    ...
    function (t, n, e) {
      ...
      function r(t, n, e) {
        ...
        if (f) {
          var s = 0.5 + ((a *= a) - (u *= u)) / (2 * f),
            l =
              Math.sqrt(Math.max(0, 2 * u * (a + f) - (a -= f) * a - u * u)) /
              (2 * f);
      ...
      function o(t) {
        ...
        if (((o = t[1]), (n.x = -o.r), (o.x = n.r), (o.y = 0), !(s > 2)))
          return n.r + o.r;
        r(o, n, (f = t[2])),
          (n = new a(n)),
          (o = new a(o)),
        ...
        t: for (d = 3; d < s; ++d) {
          ...
          for (
            f.previous = n, f.next = o, n.next = o.previous = o = f, l = u(n);
            (f = f.next) !== o;
        ...
        for (f = e.i(c.a)(n), d = 0; d < s; ++d)
          (n = t[d]), (n.x -= f.x), (n.y -= f.y);
        return f.r;
      }
      n.b = o;
      var c = e(140);
      ...
      function r(t) {
        ...
        return (
          ...
          (n.domain = function (t) {
            ...
            (c = []), (o = e.i(i.c)());
            for (var r, u, a = -1, f = t.length; ++a < f; )
              o.has((u = (r = t[a]) + "")) || o.set(u, c.push(r));
            return n;
          }),
          (n.range = function (e) {
    ...
    function (t, n, e) {
      ...
      var a = e(5),
        ...
        _ = 365 * b;
      n.a = function () {
        return u(c.H, c.F, c.p, c.n, c.l, c.j, c.f, c.b, f.b).domain([
          new Date(2e3, 0, 1),
          new Date(2e3, 0, 2),
        ]);
      };
    ...
    function (t, n, e) {
      ...
      function a(t, n) {
        return (
          ...
          e.i(o.a)(t).getComputedStyle(t, null).getPropertyValue(n)
        );
      }
      n.a = a;
      var o = e(89);
      n.b = function (t, n, e) {
        return arguments.length > 1
          ? this.each(
              (null == n ? r : "function" == typeof n ? u : i)(
                t,
                n,
                null == e ? "" : e
              )
    ...
    function (t, n, e) {
      ...
      n.a = function () {
          ...
          for (null == d && (v = p((o = e.i(r.a)()))), n = 0; n <= b; ++n) {
            if (!(n < b && h((a = t[n]), n, t)) === g)
              if ((g = !g)) (i = n), v.areaStart(), v.lineStart();
                ...
                for (v.lineEnd(), v.lineStart(), u = n - 1; u >= i; --u)
                  v.point(y[u], _[u]);
                v.lineEnd(), v.areaEnd();
              }
            g &&
              ((y[n] = +c(a, n, t)),
              (_[n] = +s(a, n, t)),
              v.point(f ? +f(a, n, t) : y[n], l ? +l(a, n, t) : _[n]));
          }
        ...
        return (
          (t.x = function (n) {
            return arguments.length
              ? ((c = "function" == typeof n ? n : e.i(i.a)(+n)), (f = null), t)
              : c;
          }),
          (t.x0 = function (n) {
            return arguments.length
          ...
          (t.x1 = function (n) {
            return arguments.length
              ? ((f =
                  null == n ? null : "function" == typeof n ? n : e.i(i.a)(+n)),
                t)
              : f;
          }),
          (t.y = function (n) {
            return arguments.length
              ? ((s = "function" == typeof n ? n : e.i(i.a)(+n)), (l = null), t)
              : s;
          }),
          (t.y0 = function (n) {
            return arguments.length
              ? ((s = "function" == typeof n ? n : e.i(i.a)(+n)), t)
              : s;
          }),
          (t.y1 = function (n) {
            return arguments.length
          ...
          (t.defined = function (n) {
            return arguments.length
              ? ((h = "function" == typeof n ? n : e.i(i.a)(!!n)), t)
              : h;
          }),
          (t.curve = function (n) {
    ...
    function (t, n, e) {
        ...
        function o(t, n, e, r) {
          for (var i, u, a = 0, o = n.length, c = e.length; a < o; ) {
            ...
            if (37 === (i = n.charCodeAt(a++))) {
              if (
                ((i = n.charAt(a++)),
                !(u = Jt[i in pt ? n.charAt(a++) : i]) || (r = u(t, e, r)) < 0)
              )
                return -1;
      ...
      function it(t, n) {
        ...
        return (
          (t = r >= 4 || 0 === r ? e.i(dt.Z)(t) : dt.Z.ceil(t)),
          o(
            dt.Z.count(e.i(dt._7)(t), t) + (4 === e.i(dt._7)(t).getUTCDay()),
            n,
            2
          )
        );
    ...
    function (t, n, e) {
      ...
      function c(t, n, r, i) {
        ...
        for (o = 0; o < x; ++o)
          if ((c = s.c[o])) {
            for (l = c.site, d = c.halfedges, h = d.length; h--; )
              s.d[d[h]] || d.splice(h, 1);
        ...
        for (o = 0; o < x; ++o)
          (c = s.c[o]) && (c.halfedges.length || delete s.c[o]);
      }
        ...
        a = (function () {
          ...
          return (
            (t.prototype.updateNeedle = function (t) {
              var n = this;
              if (!this.needle)
                return void u.warn("Gauge-chart Warning: no needle to update");
            ...
            (t.prototype.calcCoordinates = function () {
              ...
              return this.outerNeedle
                ? [
                    ...
                    {
                      x: (n + e) * Math.sin(u) + r * Math.cos(u),
                      y: -(n + e) * Math.cos(u) + r * Math.sin(u),
                    },
                    {
                      x: (n + e) * Math.sin(u) - r * Math.cos(u),
                      y: -(n + e) * Math.cos(u) - r * Math.sin(u),
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n, e) {
        var i,
          ...
          f = n.length,
          s = new Array(c * f);
        for (null == e && (e = r.b), i = a = 0; i < c; ++i)
          for (o = t[i], u = 0; u < f; ++u, ++a) s[a] = e(o, n[u]);
        return s;
      };
    },
    function (t, n, e) {
    ...
    function (t, n, e) {
      ...
      n.a = function () {
        function t(t) {
          ...
          Array.isArray(v) ||
            ((v = e.i(f.c)(d, p, v)),
            (v = e.i(c.a)(Math.ceil(d / v) * v, Math.floor(p / v) * v, v)));
          ...
          for (r = 0; r <= b; ++r)
            (g = y[r] = []),
              ...
              (g.x1 = r < b ? v[r] : p);
          for (r = 0; r < a; ++r)
            (u = o[r]), d <= u && u <= p && y[e.i(i.a)(v, u, 0, b)].push(t[r]);
          return y;
        }
        var n = o.a,
          l = a.a,
        ...
        return (
          (t.value = function (r) {
            return arguments.length
              ? ((n = "function" == typeof r ? r : e.i(u.a)(r)), t)
              : n;
          }),
          (t.domain = function (n) {
            return arguments.length
              ? ((l = "function" == typeof n ? n : e.i(u.a)([n[0], n[1]])), t)
              : l;
          }),
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        var i,
          ...
          c = 0;
        if (null == n)
          for (; ++o < u; ) isNaN((i = e.i(r.a)(t[o]))) ? --a : (c += i);
        else
          for (; ++o < u; )
            isNaN((i = e.i(r.a)(n(t[o], o, t)))) ? --a : (c += i);
        if (a) return c / a;
      };
    },
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        var a,
          ...
          f = [];
        if (null == n)
          for (; ++c < o; ) isNaN((a = e.i(i.a)(t[c]))) || f.push(a);
        else
          for (; ++c < o; ) isNaN((a = e.i(i.a)(n(t[c], c, t)))) || f.push(a);
    ...
    function (t, n, e) {
      "use strict";
      n.a = function (t) {
        for (var n, e, r, i = t.length, u = -1, a = 0; ++u < i; )
          a += t[u].length;
      ...
      n.a = function (t, n) {
        if ((e = t.length)) {
          var e,
            ...
            a = 0,
            o = t[a];
          for (null == n && (n = r.a); ++u < e; )
            (n((i = t[u]), o) < 0 || 0 !== n(o, o)) && ((o = i), (a = u));
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n, e) {
        for (
          var r, i, u = (null == e ? t.length : e) - (n = null == n ? 0 : +n);
          u;
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n, i) {
        return Math.ceil(
          (i - n) / (3.5 * e.i(r.a)(t) * Math.pow(t.length, -1 / 3))
        );
      };
    },
    function (t, n, e) {
      ...
      function l(t) {
        ...
        function l() {
          function n() {
            ...
            !K ||
              j ||
              I ||
              (Math.abs(t[0] - nt[0]) > Math.abs(t[1] - nt[1])
                ? (I = !0)
                : (j = !0)),
              (nt = t),
              (U = !0),
          ...
          function r() {
            ...
            switch (((O = nt[0] - tt[0]), (D = nt[1] - tt[1]), F)) {
              ...
              case m:
                H &&
                  ((O = Math.max($ - l, Math.min(Z - y, O))),
                  (h = l + O),
                  (A = y + O)),
                  X &&
                    ((D = Math.max(Q - p, Math.min(J - R, D))),
                    (g = p + D),
                    (L = R + D));
                break;
              case w:
                H < 0
                  ? ((O = Math.max($ - l, Math.min(Z - l, O))),
                    (h = l + O),
                    (A = y))
                  : H > 0 &&
                    ((O = Math.max($ - y, Math.min(Z - y, O))),
                    (h = l),
                    (A = y + O)),
                  X < 0
                    ? ((D = Math.max(Q - p, Math.min(J - p, D))),
                      (g = p + D),
                      (L = R))
                    : X > 0 &&
                      ((D = Math.max(Q - R, Math.min(J - R, D))),
                      (g = p),
                      (L = R + D));
                break;
              case M:
                H &&
                  ((h = Math.max($, Math.min(Z, l - O * H))),
                  (A = Math.max($, Math.min(Z, y + O * H)))),
                  X &&
                    ((g = Math.max(Q, Math.min(J, p - D * X))),
                    (L = Math.max(Q, Math.min(J, R + D * X))));
            }
            A < h &&
              ((H *= -1),
              (t = l),
          ...
          if (v.r.touches) {
            if (v.r.changedTouches.length < v.r.touches.length)
              return e.i(_.a)();
          } else if (z) return;
          if (q.apply(this, arguments)) {
            var l,
              ...
              F =
                "selection" === (v.r.metaKey ? (Y = "overlay") : Y)
                  ? m
                  : v.r.altKey
                  ? M
                  : w,
        ...
        return (
          ...
          (s.prototype = {
            ...
            emit: function (r) {
              e.i(v.s)(
                new y.a(n, r, t.output(this.state.selection)),
                L.apply,
                L,
                [r, this.that, this.args]
              );
            },
          }),
          (n.extent = function (t) {
          ...
          (n.filter = function (t) {
            return arguments.length
              ? ((q = "function" == typeof t ? t : e.i(g.a)(!!t)), n)
              : q;
          }),
      ...
      n.a = function () {
        function t(t) {
          ...
          for (
            ...
            (_[x] = { index: x, startAngle: s, endAngle: f, value: v[x] }),
              (f += l);
          }
          for (h = -1; ++h < p; )
            for (d = h - 1; ++d < p; ) {
      ...
      n.a = function () {
        function t() {
          ...
          if (
            ...
            b.arc(0, 0, a, o, f),
            (o === m && f === x) ||
              (b.quadraticCurveTo(0, 0, _ * e.i(s.b)(m), _ * e.i(s.c)(m)),
              b.arc(0, 0, _, m, x)),
        ...
        return (
          (t.radius = function (n) {
            return arguments.length
              ? ((d = "function" == typeof n ? n : e.i(f.a)(+n)), t)
              : d;
          }),
          (t.startAngle = function (n) {
            return arguments.length
              ? ((p = "function" == typeof n ? n : e.i(f.a)(+n)), t)
              : p;
          }),
          (t.endAngle = function (n) {
            return arguments.length
              ? ((v = "function" == typeof n ? n : e.i(f.a)(+n)), t)
              : v;
          }),
          (t.source = function (e) {
    ...
    function (t, n, e) {
      ...
      n.a = function () {
        function t(n, r, i, u) {
          if (r >= l.length)
            return null != c && n.sort(c), null != f ? f(n) : n;
          for (
            var a,
              s,
              h,
    ...
    function (t, n, e) {
      ...
      e.i(a.a)(
        ...
        e.i(a.b)(o.f, {
          brighter: function (t) {
            return (
              (t = null == t ? o.g : Math.pow(o.g, t)),
              new u(this.h, this.s, this.l * t, this.opacity)
            );
          },
          darker: function (t) {
            return (
              (t = null == t ? o.h : Math.pow(o.h, t)),
              new u(this.h, this.s, this.l * t, this.opacity)
            );
          },
          rgb: function () {
      ...
      (i.prototype = r.prototype =
        {
          ...
          call: function (t, n) {
            ...
            if (!this._.hasOwnProperty(t))
              throw new Error("unknown type: " + t);
            for (r = this._[t], u = 0, e = r.length; u < e; ++u)
              r[u].value.apply(n, i);
          },
    ...
    function (t, n, e) {
      ...
      n.a = function () {
        ...
        function p() {
          e.i(c.i)(c.r.view).on("mousemove.drag mouseup.drag", null),
            e.i(f.b)(c.r.view, x),
            e.i(s.a)(),
            S.mouse("end");
        }
        function v() {
          if (M.apply(this, arguments)) {
            var t,
              ...
              u = r.length;
            for (t = 0; t < u; ++t)
              (n = y(r[t].identifier, i, c.o, this, arguments)) &&
                (e.i(s.b)(), n("start"));
          }
        }
        function b() {
          var t,
            ...
            i = r.length;
          for (t = 0; t < i; ++t)
            (n = S[r[t].identifier]) && (e.i(s.a)(), n("drag"));
        }
        function g() {
          var t,
            n,
        ...
        function y(n, r, i, u, a) {
          ...
          if (
            e.i(c.s)(
              new h.a(t, "beforestart", o, n, E, l[0], l[1], 0, 0, d),
              function () {
                return (
                  null != (c.r.subject = o = N.apply(u, a)) &&
                  ((f = o.x - l[0] || 0), (s = o.y - l[1] || 0), !0)
                );
              }
            )
          )
        ...
        return (
          (t.filter = function (n) {
            return arguments.length
              ? ((M = "function" == typeof n ? n : e.i(l.a)(!!n)), t)
              : M;
          }),
          (t.container = function (n) {
            return arguments.length
              ? ((k = "function" == typeof n ? n : e.i(l.a)(n)), t)
              : k;
          }),
          (t.subject = function (n) {
            return arguments.length
              ? ((N = "function" == typeof n ? n : e.i(l.a)(n)), t)
              : N;
          }),
          (t.touchable = function (n) {
            return arguments.length
              ? ((A = "function" == typeof n ? n : e.i(l.a)(!!n)), t)
              : A;
          }),
          (t.on = function () {
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        function f() {
          if (s) {
            var n,
              e,
              r = s.length;
            for (l = new Array(r), n = 0; n < r; ++n)
              (e = s[n]), (l[e.index] = +t(e, n, s));
          }
        }
        var s,
          l,
        ...
        return (
          ...
          (n.radius = function (r) {
            return arguments.length
              ? ((t = "function" == typeof r ? r : e.i(u.a)(+r)), f(), n)
              : t;
          }),
          n
        );
      ...
      n.a = function (t) {
        ...
        function f() {
          if (p) {
            ...
            for (n = 0, b = new Array(a); n < a; ++n)
              (r = t[n]),
                (b[n] =
                  v[r.source.index] / (v[r.source.index] + v[r.target.index]));
            (h = new Array(a)), s(), (d = new Array(a)), l();
          }
        }
        function s() {
          if (p)
            for (var n = 0, e = t.length; n < e; ++n) h[n] = +y(t[n], n, t);
        }
        function l() {
          if (p)
            for (var n = 0, e = t.length; n < e; ++n) d[n] = +_(t[n], n, t);
        }
        var h,
          d,
          p,
        ...
        return (
          ...
          (c.strength = function (t) {
            return arguments.length
              ? ((y = "function" == typeof t ? t : e.i(u.a)(+t)), s(), c)
              : y;
          }),
          (c.distance = function (t) {
            return arguments.length
              ? ((_ = "function" == typeof t ? t : e.i(u.a)(+t)), l(), c)
              : _;
          }),
          c
        );
      ...
      n.a = function () {
        ...
        function n() {
          if (f) {
            var t,
              n,
              e = f.length;
            for (h = new Array(e), t = 0; t < e; ++t)
              (n = f[t]), (h[n.index] = +d(n, t, f));
          }
        }
        function o(t) {
          var n,
        ...
        return (
          ...
          (t.strength = function (i) {
            return arguments.length
              ? ((d = "function" == typeof i ? i : e.i(r.a)(+i)), n(), t)
              : d;
          }),
      ...
      n.a = function (t, n, i) {
        ...
        return (
          ...
          (u.strength = function (t) {
            return arguments.length
              ? ((s = "function" == typeof t ? t : e.i(r.a)(+t)), a(), u)
              : s;
          }),
          (u.radius = function (n) {
            return arguments.length
              ? ((t = "function" == typeof n ? n : e.i(r.a)(+n)), a(), u)
              : t;
          }),
          (u.x = function (t) {
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        return (
          ...
          (n.strength = function (t) {
            return arguments.length
              ? ((c = "function" == typeof t ? t : e.i(r.a)(+t)), i(), n)
              : c;
          }),
          (n.x = function (u) {
            return arguments.length
              ? ((t = "function" == typeof u ? u : e.i(r.a)(+u)), i(), n)
              : t;
          }),
          n
        );
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        return Math.max(
          0,
          3 * Math.max(-8, Math.min(8, Math.floor(e.i(r.a)(n) / 3))) -
            e.i(r.a)(Math.abs(t))
        );
      };
    },
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        return (
          (t = Math.abs(t)),
          (n = Math.abs(n) - t),
          Math.max(0, e.i(r.a)(n) - e.i(r.a)(t)) + 1
        );
      };
    },
    function (t, n, e) {
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        var n, r, i, u, a, o, c;
        if (
          ((b = v = -(d = p = 1 / 0)), (x = []), e.i(S.a)(t, E), (r = x.length))
        ) {
          for (x.sort(l), n = 1, i = x[0], a = [i]; n < r; ++n)
            (u = x[n]),
              h(i, u[0]) || h(i, u[1])
                ? (s(i[0], u[1]) > s(i[0], i[1]) && (i[1] = u[1]),
                  s(u[0], i[1]) > s(i[0], i[1]) && (i[0] = u[0]))
                : a.push((i = u));
          for (
            o = -1 / 0, r = a.length - 1, n = 0, i = a[r];
            n <= r;
            i = u, ++n
          )
            (u = a[n]),
              (c = s(i[1], u[0])) > o && ((o = c), (d = u[0]), (v = i[1]));
        }
        return (
          (x = w = null),
          d === 1 / 0 || p === 1 / 0
    ...
    function (t, n, e) {
      ...
      var o,
        ...
        b = {
          ...
          polygonEnd: function () {
            (b.lineStart = b.lineEnd = b.point = d.a),
              p.add(e.i(h.p)(v)),
              v.reset();
          },
          result: function () {
          ...
          switch (this._point) {
            ...
            default:
              this._context.moveTo(t + this._radius, n),
                this._context.arc(t, n, this._radius, 0, i.b);
          }
        },
        result: u.a,
      };
      ...
      n.a = function (t, n) {
        function l(t) {
          return (
            t &&
              ("function" == typeof p &&
                d.pointRadius(+p.apply(this, arguments)),
              e.i(i.a)(t, h(d))),
            d.result()
          );
        }
        ...
        return (
          ...
          (l.projection = function (n) {
            return arguments.length
              ? ((h = null == n ? ((t = null), r.a) : (t = n).stream), l)
              : t;
          }),
          ...
          (l.pointRadius = function (t) {
            return arguments.length
              ? ((p = "function" == typeof t ? t : (d.pointRadius(+t), +t)), l)
              : p;
          }),
      ...
      n.a = function () {
        ...
        return (
          ...
          (t.stream = function (t) {
            return c && f === t
              ? c
              : (c = r([p.stream((f = t)), v.stream(t), b.stream(t)]));
          }),
          (t.precision = function (t) {
            return arguments.length
              ? (p.precision(t), v.precision(t), b.precision(t), n())
              : p.precision();
          }),
          (t.scale = function (n) {
            return arguments.length
      ...
      function i(t, n) {
        ...
        var a = e.i(u.c)(t),
          c =
            t === n
              ? e.i(u.d)(t)
              : e.i(u.i)(a / e.i(u.c)(n)) / e.i(u.i)(r(n) / r(t)),
          f = (a * e.i(u.r)(r(t), c)) / c;
        return c
          ? ((i.invert = function (t, n) {
              ...
              return [
                (e.i(u.e)(t, e.i(u.p)(r)) / c) * e.i(u.q)(r),
                2 * e.i(u.l)(e.i(u.r)(f / i, 1 / c)) - u.k,
              ];
            }),
            i)
          : o.b;
      ...
      n.a = function () {
        ...
        return (l = {
          ...
          translate: function (n) {
            return arguments.length
              ? ((g = r(h * v, h * b, (d = +n[0]), (p = +n[1]))), t())
              : [d, p];
          },
          reflectX: function (n) {
            return arguments.length
              ? ((g = r(h * (v = n ? -1 : 1), h * b, d, p)), t())
              : v < 0;
          },
          reflectY: function (n) {
            return arguments.length
              ? ((g = r(h * v, h * (b = n ? -1 : 1), d, p)), t())
              : b < 0;
          },
      ...
      (r.invert = function (t, n) {
        ...
        do {
          ...
          i -= r =
            (i *
              (1.007226 +
                o * (0.015085 + c * (0.028874 * o - 0.044475 - 0.005916 * c))) -
              n) /
            (1.007226 +
              o *
                (0.045255 + c * (0.259866 * o - 0.311325 - 0.005916 * 11 * c)));
        ...
        function r(i, u, o, c, s, l, h, d, p, v, b, g, y, _) {
          ...
          if (w > 4 * n && y--) {
            var M = c + v,
              ...
              S = e.i(a.f)((N /= A)),
              T =
                e.i(a.p)(e.i(a.p)(N) - 1) < a.o || e.i(a.p)(o - p) < a.o
                  ? (o + p) / 2
                  : e.i(a.e)(k, M),
              E = t(T, S),
              C = E[0],
      ...
      n.a = function () {
        ...
        return (
          ...
          (t.padding = function (n) {
            return arguments.length
              ? ((l = "function" == typeof n ? n : e.i(f.b)(+n)), t)
              : l;
          }),
          t
        );
      ...
      n.a = function () {
        ...
        return (
          ...
          (t.paddingInner = function (n) {
            return arguments.length
              ? ((h = "function" == typeof n ? n : e.i(a.b)(+n)), t)
              : h;
          }),
          ...
          (t.paddingTop = function (n) {
            return arguments.length
              ? ((d = "function" == typeof n ? n : e.i(a.b)(+n)), t)
              : d;
          }),
          (t.paddingRight = function (n) {
            return arguments.length
              ? ((p = "function" == typeof n ? n : e.i(a.b)(+n)), t)
              : p;
          }),
          (t.paddingBottom = function (n) {
            return arguments.length
              ? ((v = "function" == typeof n ? n : e.i(a.b)(+n)), t)
              : v;
          }),
          (t.paddingLeft = function (n) {
            return arguments.length
              ? ((b = "function" == typeof n ? n : e.i(a.b)(+n)), t)
              : b;
          }),
          t
        );
      ...
      n.a = (function t(n) {
        function a(t, a, o, c, f) {
          if ((s = t._squarify) && s.ratio === n)
            for (
              var s, l, h, d, p, v = -1, b = s.length, g = t.value;
              ++v < b;

            ) {
              for (
                l = s[v], h = l.children, d = l.value = 0, p = h.length;
                d < p;
                ++d
              )
                l.value += h[d].value;
    ...
    function (t, n, e) {
      ...
      function r(t, n) {
        ...
        return function (n) {
          return (
            (t.l = r(n)), (t.a = a(n)), (t.b = o(n)), (t.opacity = c(n)), t + ""
          );
        };
      }
      n.a = r;
      ...
      function r(t) {
        return "none" === t
          ...
          : (u ||
            ...
            (u.style.transform = t),
            (t = o
              .getComputedStyle(a.appendChild(u), null)
            ...
            if (null === this._x1)
              ...
              if (Math.abs(l * c - f * s) > 1e-6 && i) {
                var d = e - a,
                  ...
                  _ =
                    i *
                    Math.tan((u - Math.acos((v + h - b) / (2 * g * y))) / 2),
                  m = _ / y,
                  x = _ / g;
                Math.abs(m - 1) > 1e-6 &&
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        for (
          var n, e, r = -1, i = t.length, u = 0, a = 0, o = t[i - 1], c = 0;
          ++r < i;
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        ...
        var e = this._x0,
          ...
          u = this._y1;
        if (isNaN(e))
          (i = (e = Math.floor(t)) + 1), (u = (r = Math.floor(n)) + 1);
        else {
        ...
        return (
          (this._x0 = e), (this._y0 = r), (this._x1 = i), (this._y1 = u), this
        );
      };
    },
    function (t, n, e) {
      ...
      (y.copy = function () {
        ...
        for (
          ...
          for (var a = 0; a < 4; ++a)
            (n = r.source[a]) &&
              (n.length
                ? t.push({ source: n, target: (r.target[a] = new Array(4)) })
                : (r.target[a] = u(n)));
        return e;
      }),
        (y.add = a.a),
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        var n,
          ...
          f = this._root;
        for (
          f && c.push(new r.a(f, this._x0, this._y0, this._x1, this._y1));
          (n = c.pop());

        )
          if (
            !t((f = n.node), (i = n.x0), (u = n.y0), (a = n.x1), (o = n.y1)) &&
            f.length
          ) {
            var s = (i + a) / 2,
              l = (u + o) / 2;
    ...
    function (t, n, e) {
      ...
      e.i(a.a)(
        ...
        e.i(a.b)(o.c, {
          brighter: function (t) {
            return (
              (t = null == t ? o.d : Math.pow(o.d, t)),
              new u(this.h, this.s, this.l * t, this.opacity)
            );
          },
          darker: function (t) {
            return (
              (t = null == t ? o.e : Math.pow(o.e, t)),
              new u(this.h, this.s, this.l * t, this.opacity)
            );
          },
          rgb: function () {
    ...
    function (t, n, e) {
      ...
      function f() {
        function t() {
          return (
            (v = o(h)), (b = a(h)), u()[0] < 0 && ((v = c(v)), (b = c(b))), n
          );
        }
        ...
        return (
          (n.invertExtent = function (t) {
            ...
            return n < 0
              ...
              : [
                  n > 0 ? c[n - 1] : a[0],
                  n < c.length ? c[n] : a[a.length - 1],
                ];
          }),
          (n.domain = function (n) {
            if (!arguments.length) return a.slice();
            a = [];
            for (var e, r = 0, u = n.length; r < u; ++r)
              null == (e = n[r]) || isNaN((e = +e)) || a.push(e);
            return a.sort(i.d), t();
          }),
          (n.range = function (n) {
    ...
    function (t, n, e) {
      ...
      function r() {
        ...
        return (
          (t.domain = function (e) {
            return arguments.length
              ? ((n = u.b.call(e)), (o = Math.min(n.length, a.length - 1)), t)
              : n.slice();
          }),
          (t.range = function (e) {
            return arguments.length
              ? ((a = u.b.call(e)), (o = Math.min(n.length, a.length - 1)), t)
              : a.slice();
          }),
          (t.invertExtent = function (t) {
            var e = a.indexOf(t);
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        ...
        if (arguments.length < 2) {
          var l = this.node();
          return s.local
            ? l.getAttributeNS(s.space, s.local)
            : l.getAttribute(s);
        }
        return this.each(
          (null == n
    ...
    function (t, n, e) {
      ...
      (u.prototype = {
        ...
        (n.a = function (t, n) {
          var e = r(t + "");
          if (arguments.length < 2) {
            for (var u = i(this.node()), a = -1, o = e.length; ++a < o; )
    ...
    function (t, n, e) {
      ...
      function i(t, n, e, r, i, u, o) {
        ...
        for (f = 0; f < d; ++f)
          (s = n[f]) &&
            ((v[f] = l = c + o.call(s, s.__data__, f, n)),
            l in h ? (i[f] = s) : (h[l] = s));
        for (f = 0; f < p; ++f)
          (l = c + o.call(t, u[f], f, u)),
            (s = h[l])
              ? ((r[f] = s), (s.__data__ = u[f]), (h[l] = null))
              : (e[f] = new a.b(t, u[f]));
      ...
      function r(t, n, r) {
        ...
        "function" == typeof u
          ...
          : ((u = i.document.createEvent("Event")),
            r
              ? (u.initEvent(n, r.bubbles, r.cancelable), (u.detail = r.detail))
              : u.initEvent(n, !1, !1)),
          t.dispatchEvent(u);
      }
      function i(t, n) {
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        for (var n = this._groups, e = 0, r = n.length; e < r; ++e)
          for (var i, u = n[e], a = 0, o = u.length; a < o; ++a)
            (i = u[a]) && t.call(i, i.__data__, a, u);
        return this;
      };
    },
    function (t, n, e) {
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        for (
          ...
          for (
            var c, f = n[o], s = f.length, l = (a[o] = []), h = 0;
            h < s;
            ++h
          )
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        for (
          ...
          for (
            var c, f, s = n[o], l = s.length, h = (a[o] = new Array(l)), d = 0;
            d < l;
            ++d
          )
            (c = s[d]) &&
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        "function" != typeof t && (t = e.i(i.a)(t));
        for (
          var n = this._groups, u = n.length, a = [], o = [], c = 0;
          c < u;
          ++c
        )
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        t || (t = r);
        for (
          var e = this._groups, u = e.length, a = new Array(u), o = 0;
          o < u;
          ++o
        ) {
          for (
            var c, f = e[o], s = f.length, l = (a[o] = new Array(s)), h = 0;
            h < s;
            ++h
          )
            (c = f[h]) && (l[h] = c);
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n, u) {
        ...
        for (var a, o = 0, c = n ? n.length : 0; o < c; ++o)
          if ((a = n[o]).identifier === u) return e.i(i.a)(t, a);
        return null;
      };
    },
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        ...
        for (var u = 0, a = n ? n.length : 0, o = new Array(a); u < a; ++u)
          o[u] = e.i(i.a)(t, n[u]);
        return o;
      };
    },
          ...
          if (
            ...
            if (l > h.c - h.a)
              _.moveTo(u * e.i(h.h)(a), u * e.i(h.i)(a)),
                _.arc(0, 0, u, a, o, !m),
                i > h.a &&
                  (_.moveTo(i * e.i(h.h)(o), i * e.i(h.i)(o)),
                  _.arc(0, 0, i, o, a, m));
            else {
              var x,
                w,
                ...
                C =
                  E > h.a &&
                  (v ? +v.apply(this, arguments) : e.i(h.d)(i * i + u * u)),
                  ...
                  var H = S > h.a ? c(O, D, Y, F, I, B, U, j) : [U, j],
                    ...
                    $ =
                      ...
                      e.i(h.i)(
                        e.i(h.l)(
                          (X * V + G * W) /
                            (e.i(h.d)(X * X + G * G) * e.i(h.d)(V * V + W * W))
                        ) / 2
                      ),
                    ...
                    R < P
                      ...
                      : (_.arc(
                        ...
                        _.arc(
                          ...
                          0,
                          u,
                          e.i(h.m)(x.cy + x.y11, x.cx + x.x11),
                          e.i(h.m)(w.cy + w.y11, w.cx + w.x11),
                          !m
                        ),
                        _.arc(
                          w.cx,
        ...
        return (
          (t.centroid = function () {
            var t = (+n.apply(this, arguments) + +d.apply(this, arguments)) / 2,
              r =
                (+b.apply(this, arguments) + +g.apply(this, arguments)) / 2 -
                h.b / 2;
            return [e.i(h.h)(r) * t, e.i(h.i)(r) * t];
          }),
          (t.innerRadius = function (r) {
            return arguments.length
              ? ((n = "function" == typeof r ? r : e.i(l.a)(+r)), t)
              : n;
          }),
          (t.outerRadius = function (n) {
            return arguments.length
              ? ((d = "function" == typeof n ? n : e.i(l.a)(+n)), t)
              : d;
          }),
          (t.cornerRadius = function (n) {
            return arguments.length
              ? ((p = "function" == typeof n ? n : e.i(l.a)(+n)), t)
              : p;
          }),
          (t.padRadius = function (n) {
            return arguments.length
              ? ((v =
                  null == n ? null : "function" == typeof n ? n : e.i(l.a)(+n)),
                t)
              : v;
          }),
          (t.startAngle = function (n) {
            return arguments.length
              ? ((b = "function" == typeof n ? n : e.i(l.a)(+n)), t)
              : b;
          }),
          (t.endAngle = function (n) {
            return arguments.length
              ? ((g = "function" == typeof n ? n : e.i(l.a)(+n)), t)
              : g;
          }),
          (t.padAngle = function (n) {
            return arguments.length
              ? ((y = "function" == typeof n ? n : e.i(l.a)(+n)), t)
              : y;
          }),
          (t.context = function (n) {
        ...
        point: function (t, n) {
          switch (((t = +t), (n = +n), this._point)) {
            ...
            case 2:
              ...
              this._line
                ? this._context.lineTo(r, u)
                : this._context.moveTo(r, u);
              break;
            case 3:
              this._point = 4;
            default:
    ...
    function (t, n, e) {
      ...
      (r.prototype = {
        ...
        lineEnd: function () {
          ...
          if (e > 0)
            for (
              var r, i = t[0], u = n[0], a = t[e] - i, o = n[e] - u, c = -1;
              ++c <= e;
    ...
    function (t, n, e) {
      ...
      function i(t) {
        ...
        for (
          i[r - 1] = 2, u[r - 1] = 7, a[r - 1] = 8 * t[r - 1] + t[r], n = 1;
          n < r;
          ++n
        )
          (e = i[n] / u[n - 1]), (u[n] -= e), (a[n] -= e * a[n - 1]);
        for (i[r - 1] = a[r - 1] / u[r - 1], n = r - 2; n >= 0; --n)
          i[n] = (a[n] - i[n + 1]) / u[n];
    ...
    function (t, n, e) {
      ...
      function u(t) {
        ...
        return (
          ...
          (n.x = function (t) {
            return arguments.length
              ? ((o = "function" == typeof t ? t : e.i(p.a)(+t)), n)
              : o;
          }),
          (n.y = function (t) {
            return arguments.length
              ? ((c = "function" == typeof t ? t : e.i(p.a)(+t)), n)
              : c;
          }),
      ...
      function c(t, n, r, i, u) {
        var a = e.i(b.a)(n, r),
          ...
          f = e.i(b.a)(i, u);
        t.moveTo(a[0], a[1]),
          t.bezierCurveTo(o[0], o[1], c[0], c[1], f[0], f[1]);
      }
      function f() {
        return u(a);
      }
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        for (n = 0; n < a; ++n)
          (u = c[n]),
            f < s ? ((f += o[u]), l.push(u)) : ((s += o[u]), h.push(u));
    ...
    function (t, n, e) {
      ...
      n.a = function () {
        ...
        return (
          (t.value = function (i) {
            return arguments.length
              ? ((n = "function" == typeof i ? i : e.i(r.a)(+i)), t)
              : n;
          }),
          ...
          (t.startAngle = function (n) {
            return arguments.length
              ? ((f = "function" == typeof n ? n : e.i(r.a)(+n)), t)
              : f;
          }),
          (t.endAngle = function (n) {
            return arguments.length
              ? ((s = "function" == typeof n ? n : e.i(r.a)(+n)), t)
              : s;
          }),
          (t.padAngle = function (n) {
            return arguments.length
              ? ((l = "function" == typeof n ? n : e.i(r.a)(+n)), t)
              : l;
          }),
          t
        );
    ...
    function (t, n, e) {
      ...
      n.a = function () {
        ...
        return (
          (t.keys = function (r) {
            return arguments.length
              ? ((n = "function" == typeof r ? r : e.i(u.a)(i.a.call(r))), t)
              : n;
          }),
          (t.value = function (n) {
            return arguments.length
              ? ((s = "function" == typeof n ? n : e.i(u.a)(+n)), t)
              : s;
          }),
          (t.order = function (n) {
            return arguments.length
    ...
    function (t, n, e) {
      ...
      n.a = function () {
        function t() {
          ...
          if (
            (a || (a = t = e.i(r.a)()),
            n.apply(this, arguments).draw(a, +u.apply(this, arguments)),
            t)
          )
        ...
        return (
          ...
          (t.size = function (n) {
            return arguments.length
              ? ((u = "function" == typeof n ? n : e.i(l.a)(+n)), t)
              : u;
          }),
          (t.context = function (n) {
    ...
    function (t, n, e) {
      ...
      var r = e(4),
        ...
        u = e.i(r.a)(
          ...
          function (t, n) {
            return (
              (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * i.d) /
              i.b
            );
          },
          function (t) {
      ...
      var r = e(4),
        ...
        u = e.i(r.a)(
          function (t) {
            ...
            n < 0 && (n += i.c),
              t.setTime(Math.floor((+t - n) / i.c) * i.c + n);
          },
          function (t, n) {
            t.setTime(+t + n * i.c);
          },
    ...
    function (t, n, e) {
      ...
      function r(t) {
        return e.i(i.a)(
          ...
          function (t, n) {
            return (
              (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * u.d) /
              u.a
            );
          }
        );
    ...
    function (t, n, e) {
      ...
      n.a = function (t, n) {
        ...
        if (o) {
          n = null == n ? null : n + "";
          for (a in o)
            if ((e = o[a]).state > i.d && e.name === n)
              return new r.b([[t]], u, n, +a);
        }
        return null;
      };
    },
    ...
    function (t, n, e) {
      ...
      function r(t, n) {
        for (var r; !(r = t.__transition) || !(r = r[n]); )
          if (!(t = t.parentNode)) return (c.time = e.i(o.a)()), c;
        return r;
      }
      var i = e(13),
        u = e(8),
      ...
      n.a = function (t) {
        ...
        for (var f = this._groups, s = f.length, l = 0; l < s; ++l)
          for (var h, d = f[l], p = d.length, v = 0; v < p; ++v)
            (h = d[v]) && e.i(u.h)(h, t, n, v, d, a || r(h, n));
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        for (
          var o = this._groups, c = o.length, f = new Array(c), s = 0;
          s < c;
          ++s
        )
          for (
            var l, h, d = o[s], p = d.length, v = (f[s] = new Array(p)), b = 0;
            b < p;
            ++b
          )
            (l = d[b]) &&
              ...
              (v[b] = h),
              e.i(u.h)(v[b], n, a, b, v, e.i(u.f)(l, a)));
    ...
    function (t, n, e) {
      ...
      n.a = function (t) {
        ...
        for (
          var o = this._groups, c = o.length, f = [], s = [], l = 0;
          l < c;
          ++l
        )
    ...
    function (t, n, e) {
      ...
      function a(t, n, r) {
        ...
        return function () {
          ...
          return (
            null == f &&
              (this.style.removeProperty(t), (f = e.i(c.n)(this, t))),
    ...
    function (t, n, e) {
      ...
      function a(t) {
        ...
        for (
          var s = o;
          s.circle &&
          Math.abs(r - s.circle.x) < p.b &&
          Math.abs(i - s.circle.cy) < p.b;
        ...
        for (
          var l = c;
          l.circle &&
          Math.abs(r - l.circle.x) < p.b &&
          Math.abs(i - l.circle.cy) < p.b;
        ...
        var v,
          b = f.length;
        for (v = 1; v < b; ++v)
          (l = f[v]), (s = f[v - 1]), e.i(d.c)(l.edge, s.site, l.site, a);
        (s = f[0]),
          (l = f[b - 1]),
          (l.edge = e.i(d.d)(s.site, l.site, null, a)),
          e.i(h.c)(s),
          e.i(h.c)(l);
      }
      function o(t) {
      ...
      n.a = function () {
        function t(t) {
          return new u.a(
            t.map(function (e, r) {
              var i = [
                Math.round(n(e, r, t) / u.b) * u.b,
                Math.round(a(e, r, t) / u.b) * u.b,
              ];
        ...
        return (
          ...
          (t.y = function (n) {
            return arguments.length
              ? ((a = "function" == typeof n ? n : e.i(r.a)(+n)), t)
              : a;
          }),
          (t.extent = function (n) {
            return arguments.length
    ...
    function (t, n, e) {
      ...
      n.a = function () {
        ...
        function n(t, n) {
          return (
            (n = Math.max(O[0], Math.min(O[1], n))),
            n === t.k ? t : new b.c(n, t.x, t.y)
          );
        }
        function y(t, n, e) {
          var r = n[0] - e[0] * t.k,
        ...
        function x(t, n) {
          for (var e, r = 0, i = I.length; r < i; ++r)
            if ((e = I[r]).that === t) return e;
          return new w(t, n);
        }
        function w(t, n) {
          (this.that = t),
        ...
        function M() {
          ...
          if (P.apply(this, arguments)) {
            var r = x(this, arguments),
              ...
              u = Math.max(
                O[0],
                Math.min(O[1], i.k * Math.pow(2, q.apply(this, arguments)))
              ),
              a = e.i(h.e)(this);
            if (r.wheel)
              (r.mouse[0][0] === a[0] && r.mouse[0][1] === a[1]) ||
                (r.mouse[1] = i.invert((r.mouse[0] = a))),
            ...
            e.i(g.a)(),
              ...
              r.zoom(
                "mouse",
                R(y(n(i, u), r.mouse[0], r.mouse[1]), r.extent, D)
              );
          }
        }
        function k() {
          function t() {
            ...
            r.zoom(
              "mouse",
              R(
                y(r.that.__zoom, (r.mouse[0] = e.i(h.e)(r.that)), r.mouse[1]),
                r.extent,
                D
              )
            );
          ...
          if (!C && P.apply(this, arguments)) {
            ...
            e.i(s.b)(h.r.view),
              e.i(g.b)(),
              (r.mouse = [u, this.__zoom.invert(u)]),
              e.i(d.c)(this),
              r.start();
          }
        }
        function N() {
          if (P.apply(this, arguments)) {
            ...
            e.i(g.a)(),
              U > 0
                ? e.i(h.i)(this).transition().duration(U).call(m, o, i)
                : e.i(h.i)(this).call(t.transform, o);
          }
        }
        function A() {
          if (P.apply(this, arguments)) {
            ...
            if (E && ((E = clearTimeout(E)), !u.touch1))
              return (
                u.end(),
                void (
                  (i = e.i(h.i)(this).on("dblclick.zoom")) &&
        ...
        return (
          ...
          (w.prototype = {
            start: function () {
              return (
                1 == ++this.active &&
                  ((this.index = I.push(this) - 1), this.emit("start")),
                this
              );
            },
            zoom: function (t, n) {
            ...
            emit: function (n) {
              e.i(h.s)(new v.a(t, n, this.that.__zoom), B.apply, B, [
                n,
                this.that,
                this.args,
              ]);
          ...
          (t.wheelDelta = function (n) {
            return arguments.length
              ? ((q = "function" == typeof n ? n : e.i(p.a)(+n)), t)
              : q;
          }),
          (t.filter = function (n) {
            return arguments.length
              ? ((P = "function" == typeof n ? n : e.i(p.a)(!!n)), t)
              : P;
          }),
          (t.touchable = function (n) {
            return arguments.length
              ? ((L = "function" == typeof n ? n : e.i(p.a)(!!n)), t)
              : L;
          }),
          (t.extent = function (n) {
            return arguments.length
